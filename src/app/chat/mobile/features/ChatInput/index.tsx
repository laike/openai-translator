import { MobileChatInputArea, MobileChatSendButton } from '@toboto/lobehub-ui'
...
const ChatInputMobileLayout = memo(() => {
    ...
    return (
        <MobileChatInputArea
            ...
            textAreaRightAddons={<MobileChatSendButton loading={loading} onSend={onSend} onStop={onStop} />}
            topAddons={
                <>
                    <Files />
