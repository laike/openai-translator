...
import { ActionIcon, Avatar, ChatHeader, ChatHeaderTitle, Tag } from '@toboto/lobehub-ui'
...
const Left = memo(() => {
    ...
    const [isInbox, title, description, avatar, backgroundColor, model, plugins] = useSessionStore((s) => [
...
const Right = memo(() => {
    ...
    const [showAgentSettings, toggleConfig] = useGlobalStore((s) => [s.preference.showChatSideBar, s.toggleChatSideBar])
