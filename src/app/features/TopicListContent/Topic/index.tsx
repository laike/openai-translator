import { EmptyCard } from '@toboto/lobehub-ui'
...
export const Topic = () => {
    ...
    const [visible, updateGuideState] = useGlobalStore((s) => [s.preference.guide?.topic, s.updateGuideState])
    ...
    return !topicsInit ? (
        ...
        <Flexbox gap={2} style={{ marginBottom: 12 }}>
            ...
            <TopicItem active={!activeTopicId} fav={false} title={t('topic.defaultTitle', { ns: 'chat' })} />
