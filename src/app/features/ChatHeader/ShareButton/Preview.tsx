...
import { Avatar, ChatHeaderTitle, Logo, Markdown, Tag } from '@toboto/lobehub-ui'
...
const Preview = memo<FieldType & { title?: string }>(({ title, withSystemRole, withBackground, withFooter }) => {
    const [isInbox, description, avatar, backgroundColor, model, plugins, systemRole] = useSessionStore((s) => [
