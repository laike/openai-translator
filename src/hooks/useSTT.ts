import { getRecordMineType } from '@toboto/tts'
import { OpenAISTTOptions, SpeechRecognitionOptions, useOpenAISTT, useSpeechRecognition } from '@toboto/tts/react'
...
export const useSTT = (config: STTConfig) => {
    ...
    const sttLocale =
        ttsAgentSettings?.sttLocale && ttsAgentSettings.sttLocale !== 'auto' ? ttsAgentSettings.sttLocale : locale
