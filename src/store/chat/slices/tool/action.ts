...
export const chatPlugin: StateCreator<ChatStore, [['zustand/devtools', never]], [], ChatPluginAction> = (set, get) => ({
    ...
    triggerFunctionCall: async (id) => {
        ...
        const { invokeDefaultTypePlugin, invokeMarkdownTypePlugin, invokeBuiltinTool, refreshMessages } = get()
