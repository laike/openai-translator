...
import { LobeAgentSession, LobeAgentSettings, LobeSessionType, LobeSessions } from '@/types/session'
...
export const createSessionSlice: StateCreator<SessionStore, [['zustand/devtools', never]], [], SessionAction> = (
    ...
    createSession: async (agent) => {
        ...
        const defaultAgent = merge(initLobeSession, settingsSelectors.defaultAgent(useGlobalStore.getState()))
