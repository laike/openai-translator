...
export interface TTSFileAction {
    ...
    uploadTTSByArrayBuffers: (messageId: string, arrayBuffers: ArrayBuffer[]) => Promise<string | undefined>
...
export const createTTSFileSlice: StateCreator<FileStore, [['zustand/devtools', never]], [], TTSFileAction> = (
    _,
    get
) => ({
