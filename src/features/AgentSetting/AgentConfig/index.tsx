import { Form, ItemGroup, SelectWithImg, SliderWithInput } from '@toboto/lobehub-ui'
...
const AgentConfig = memo(() => {
    ...
    return <Form form={form} items={[chat, model]} onValuesChange={debounce(updateConfig, 100)} {...FORM_STYLE} />
})
