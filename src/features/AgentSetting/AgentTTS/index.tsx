import { VoiceList } from '@toboto/tts'
import { Form, ItemGroup } from '@toboto/lobehub-ui'
...
const AgentTTS = memo(() => {
    ...
    const updateConfig = useStore((s: { setAgentConfig: any }) => s.setAgentConfig)
    ...
    const config = useStore((s: { config: any }) => s.config, isEqual)
