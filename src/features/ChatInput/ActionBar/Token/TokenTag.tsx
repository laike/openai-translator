import { TokenTag, Tooltip } from '@toboto/lobehub-ui'
...
const Token = memo(() => {
    ...
    const [input, messageString] = useChatStore((s) => [s.inputMessage, chatSelectors.chatsMessageString(s)])
    ...
    return (
        <Tooltip placement={'bottom'} title={t('tokenDetail', { chatsToken, systemRoleToken, toolsToken })}>
            <TokenTag
