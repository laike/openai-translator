...
class _DEBUG_MODEL extends BaseModel<'sessions'> {
    ...
    createRandomData = async ({ sessionCount = 10, topicCount = 2000, messageCount = 10_000, startIndex = 1 }) => {
        ...
        await this.db.transaction('rw', this.db.sessions, this.db.topics, this.db.messages, async () => {
