...
export class MigrationV1ToV2 implements Migration {
    ...
    migrateSession = (session: V1Session, finalMessages: V2Message[], finalTopics: V2Topic[]): V2Session => {
    ...
    migrate(data: MigrationData<V1ConfigState>): MigrationData<V2ConfigState> {
        ...
        const sessions: V2Session[] = Object.values(v1Session).map((s) => this.migrateSession(s, v2Messages, v2Topics))
