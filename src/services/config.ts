...
class ConfigService {
    ...
    private getSession = (id: string) => sessionSelectors.getSessionById(id)(useSessionStore.getState())

    private getAgent = (id: string) => sessionExportSelectors.getExportAgent(id)(useSessionStore.getState())

    private mapImportResult = (input: { added: number; errors?: Error[]; skips: string[] }): ImportResult => {
        return {
            added: input.added,
